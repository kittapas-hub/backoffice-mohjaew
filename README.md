...
- ไฟล์: JPG / PNG / WebP เท่านั้น, ≤ 5 MB, 100–8000 px ต่อด้าน,
...
4. ตั้ง env ทั้ง 3 ตัวบน Vercel Production (`SLIP_RECEIVER_ACCOUNTS` ให้เก็บ
   ค่าจากการ verify สลิปจริงก่อนหนึ่งใบผ่าน staging)
5. Deploy แล้วทดสอบด้วยการจอง + โอนจริงยอดเล็ก 1 รายการ
